...
public class ShangpinOrderEntity<T> implements Serializable {
     ...
     * 取物类型
     */
    @ColumnInfo(comment="取物类型",type="int(11)")
    @TableField(value = "quwu_types")

    private Integer quwuTypes;
    ...
    public void setQuwuTypes(Integer quwuTypes) {
        this.quwuTypes = quwuTypes;
    }
    /**
	 * 获取：实付价格
	 */
