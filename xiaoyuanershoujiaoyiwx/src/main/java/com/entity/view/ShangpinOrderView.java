...
public class ShangpinOrderView extends ShangpinOrderEntity implements Serializable {
	...
	* 取物类型的值
	*/
	@ColumnInfo(comment="取物类型的字典表值",type="varchar(200)")
	private String quwuValue;
	/**
	* 订单类型的值
	*/
	...
	* 获取： 取物类型的值
	*/
	public String getQuwuValue() {
		return quwuValue;
	}
	/**
	* 设置： 取物类型的值
	*/
	public void setQuwuValue(String quwuValue) {
		this.quwuValue = quwuValue;
	}
	//当前表的
	/**
	* 获取： 订单类型的值
