    ...
    export default {
        ...
        methods: {
            ...
            quwuTypesChange(e) {
                ...
                this.ruleForm.quwuValue = this.quwuTypesOptions[this.quwuTypesIndex].indexName
                this.ruleForm.quwuTypes = this.quwuTypesOptions[this.quwuTypesIndex].codeIndex
            },
            ...
            async onSubmitTap() {
				...
				if ((!this.ruleForm.quwuTypes)) {
                    this.$utils.msg(`取物类型不能为空`);
                    return
                }
