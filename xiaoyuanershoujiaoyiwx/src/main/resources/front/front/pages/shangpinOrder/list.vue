            ...
            <view v-for="(item,index) in list" :key="index">
                <view class="bg-white margin-sm padding-sm solids-bottom radius text-content">
                    ...
                    <view class="flex justify-end" style="font-size: 24upx;">
                        <view v-if="item.shangpinOrderTypes==101 && item.yonghuId == user.id">
                            <view @tap="refund(item)" class="round cu-btn lines-grey mid  margin-right-sm">退款</view>
                        </view>
                        <view v-if="item.shangpinOrderTypes==104 && item.yonghuId == user.id">
                            <view @tap="commentback(item.id)" class="round cu-btn lines-grey mid  margin-right-sm">评价</view>
                        </view>
                        <view v-if="item.shangpinOrderTypes==103 && item.yonghuId == user.id">
                        ...
                        <view v-if="item.shangpinOrderTypes==101 && item.shangpinYonghuId == user.id">
                            <view @tap="openDeliver(item.id,item.quwuTypes)"
			...
			<uni-popup class="popup-content" ref="deliver" type="center">
                <form class="popup-form">
                    <view class="uni-flex uni-column"
                        ...
                        <view v-if="shangpinOrderTypes == 1">
							<view class="flex-item flex-item-V"
						...
						<view v-if="shangpinOrderTypes == 2">
							<view class="flex-item flex-item-V"
							      style="text-align: center;font-size: 40upx;font-weight: bold;margin: 20upx;">交易信息</view>
							<view class="flex-item flex-item-V" style="margin: 0 10rpx 0 10rpx;">
							    交易地点：
							    <input :style='{"padding":"0 30rpx","boxShadow":"0 0 16rpx var(--publicSubColor) inset","backgroundColor":"rgba(255, 255, 255, 1)","borderColor":"var(--publicMainColor)","borderRadius":"20rpx","color":"var(--publicMainColor)","textAlign":"left","borderWidth":"2rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
							           v-model="shangpinOrderCourierName" placeholder="交易地点"></input>
							</view>
							<view class="flex-item flex-item-V" style="margin: 0 10rpx 0 10rpx;">
							    联系方式：
							    <input :style='{"padding":"0 30rpx","boxShadow":"0 0 16rpx var(--publicSubColor) inset","backgroundColor":"rgba(255, 255, 255, 1)","borderColor":"var(--publicMainColor)","borderRadius":"20rpx","color":"var(--publicMainColor)","textAlign":"left","borderWidth":"2rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
							           v-model="shangpinOrderCourierNumber" placeholder="联系方式"></input>
							</view>
						</view>
