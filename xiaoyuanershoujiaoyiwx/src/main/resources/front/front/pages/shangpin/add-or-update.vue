        ...
        <form class="app-update-pv">
            ...
            <view
                ...
                <view
                    ...
                    <input
                             :style='{"padding":"0 30rpx","boxShadow":"0 0 16rpx var(--publicSubColor) inset","backgroundColor":"rgba(255, 255, 255, 1)","borderColor":"var(--publicMainColor)","borderRadius":"20rpx","color":"var(--publicMainColor)","textAlign":"left","borderWidth":"2rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
                             :disabled="ro.shangpinOldMoney" type="digit" v-model="ruleForm.shangpinOldMoney" placeholder="选填，原价"></input>
                </view>
                <view
                        :style='{"boxShadow":"0","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"rgba(228, 232, 230, 1)","margin":"0 0 0px 0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"100rpx"}'
                        class="cu-form-group">
                    ...
                    <input
                             :style='{"padding":"0 30rpx","boxShadow":"0 0 16rpx var(--publicSubColor) inset","backgroundColor":"rgba(255, 255, 255, 1)","borderColor":"var(--publicMainColor)","borderRadius":"20rpx","color":"var(--publicMainColor)","textAlign":"left","borderWidth":"2rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
                             :disabled="ro.shangpinNewMoney" type="digit" v-model="ruleForm.shangpinNewMoney" placeholder="必填，现价/售价"></input>
                </view>
                <view
                        :style='{"boxShadow":"0","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"rgba(228, 232, 230, 1)","margin":"0 0 0px 0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"100rpx"}'
                        class="cu-form-group">
    ...
    export default {
        ...
        methods: {
            ...
            async onSubmitTap() {
				...
				if (this.ruleForm.shangpinNewMoney === '' || this.ruleForm.shangpinNewMoney === null || this.ruleForm.shangpinNewMoney === undefined) {
                    this.$utils.msg(`现价不能为空`);
                    return
                }
				const newMoney = Number(this.ruleForm.shangpinNewMoney);
				if (isNaN(newMoney) || newMoney < 0) {
					this.$utils.msg(`现价请输入有效数字且不能为负`);
					return;
				}
				// 提交前转为数字，便于后端写入数据库
				this.ruleForm.shangpinNewMoney = newMoney;
				this.ruleForm.shangpinOldMoney = (this.ruleForm.shangpinOldMoney === '' || this.ruleForm.shangpinOldMoney === null || this.ruleForm.shangpinOldMoney === undefined) ? null : Number(this.ruleForm.shangpinOldMoney);
				if (this.ruleForm.shangpinOldMoney !== null && (isNaN(this.ruleForm.shangpinOldMoney) || this.ruleForm.shangpinOldMoney < 0)) {
					this.$utils.msg(`原价请输入有效数字且不能为负`);
					return;
				}
