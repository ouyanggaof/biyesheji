...
// element ui 完全引入（生产构建由 vue.config.js externals + index.html CDN 提供，减小打包内存）
import ElementUI from 'element-ui'
import '@/assets/css/element-theme-override.css'
...
// 生产构建用 CDN 加载 macarons；开发环境仍从 node_modules 注册主题（勿删）
