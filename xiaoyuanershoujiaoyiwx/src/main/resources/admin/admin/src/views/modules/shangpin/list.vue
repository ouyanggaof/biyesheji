            ...
            <el-form :inline="true" :model="searchForm" class="form-content">
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        >报表</el-button>
                        &nbsp;
                        <!-- 静态页免 npm 打包：部署后与后台同域访问 /xiaoyuanershoujiaoyiwx/shangpin-guanli-chat.html -->
                        <a class="el-button el-button--warning"
                           style="text-decoration:none;display:inline-block;line-height:32px;padding:0 15px;border-radius:4px;"
                           href="/xiaoyuanershoujiaoyiwx/shangpin-guanli-chat.html"
                           target="_blank"
                        >用户咨询(静态页)</a>
                        &nbsp;
