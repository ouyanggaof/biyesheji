        ...
        <div v-if="showFlag">
            <el-form :inline="true" :model="searchForm" class="form-content">
                <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                     ...
                     <el-form-item :label="contents.inputTitle == 1 ? '取物类型' : ''">
                        <el-select v-model="searchForm.quwuTypes" placeholder="请选择取物类型">
                            <el-option label="=-请选择-=" value=""></el-option>
                            <el-option
                               v-for="(item,index) in quwuTypesSelectSearch"
                               v-bind:key="index"
    ...
    //当前表下拉框搜索条件
        ...
        methods: {
            ...
            getDataList() {
                ...
                if (this.searchForm.quwuTypes!= '' && this.searchForm.quwuTypes!= undefined) {
                    params['quwuTypes'] = this.searchForm.quwuTypes
                }
                ...
                //填充下拉框选项
                this.$http({
                    url: "dictionary/page?dicCode=quwu_types&page=1&limit=100",
                    method: "get",
                }).then(({data}) => {
                    if(data && data.code === 0){
                        this.quwuTypesSelectSearch = data.data.list;
                    }
                });
                //填充下拉框选项
                this.$http({
