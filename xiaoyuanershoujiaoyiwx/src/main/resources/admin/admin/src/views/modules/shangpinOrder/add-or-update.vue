        ...
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="取物类型" prop="quwuTypes">
                        <el-select v-model="ruleForm.quwuTypes" :disabled="ro.quwuTypes" placeholder="请选择取物类型">
                            <el-option
                                v-for="(item,index) in quwuTypesOptions"
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="取物类型" prop="quwuValue">
                        <el-input v-model="ruleForm.quwuValue"
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                rules: {
                   ...
                   quwuTypes: [
                              { required: true, message: '取物类型不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=quwu_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.quwuTypesOptions = data.data.list;
                    }
                });
                this.$http({
